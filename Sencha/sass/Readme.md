...
folder are mapped to the application's root namespace, 'ExtJs.Resharper.Conflict'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJs.Resharper.Conflict' in the same way
as `"ExtJs.Resharper.Conflict/sass/src"`.
